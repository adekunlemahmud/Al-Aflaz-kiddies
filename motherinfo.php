                                ...
                                <tbody>
                                    ...
                                    <tr class="py-2">
                                        <td scope="row" class=" border border-right-0">
                                            ...
                                            <span class="">Mother's Fullname:</span>
                                        </td>
                                        <td class="border-top border-bottom"><?php  echo $smother_name; ?></td>
                                        <td class="border-top border-bottom titles"><?php echo  $lmother_name;  ?></td>
                                     ...
                                     <tr class="py-2">
                                        ...
                                        <td class="border-top border-bottom"><?php  echo $mother_home; ?></td>
                                        <td class="border-top border-bottom titles"></td>
                                        <td class="border-top border-bottom titles"></td>
                                    ...
                                    <tr class="py-2">
                                        ...
                                        <td class="border-top border-bottom"><?php  echo $mother_phone; ?></td>
                                        <td class="border-top border-bottom titles"></td>
                                        <td class="border-top border-bottom titles"></td>
                                    ...
                                    <tr class="py-2">
                                        ...
                                        <td class="border-top border-bottom"><?php  echo $mother_occupation; ?></td>
                                        <td class="border-top border-bottom titles"></td>
                                        <td class="border-top border-bottom titles"></td>
                                     ...
                                     <tr class="py-2">
                                        ...
                                        <td class="border-top border-bottom"><?php  echo $mother_email; ?></td>
                                        <td class="border-top border-bottom titles"></td>
                                        <td class="border-top border-bottom titles"></td>
