            ...
            <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
                <div class="container-fluid">
                    <button type="button" id="sidebarCollapse" class="navbar-btn">
                        ...
                        <thead>
                        <th scope="col" id="thead" class="relp"> Debt Issues</th>
...
<div class="btn-group cent" role= "group" >
 <a href="debtors.php">
  <button class="btn btn-secondary" type="button" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseExample">
    Debtors
  </button > </a>
  <a href="nondebtors.php">
