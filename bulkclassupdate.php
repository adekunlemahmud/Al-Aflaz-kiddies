...
// echo "$admissionNo"; echo "$username";
...
if (isset($_POST["submit"])){
    ...
    $newclass = mysqli_real_escape_string($link, $_REQUEST['newclass']);
    

    
         $sql = "UPDATE registration set  `present_class` = '$newclass' WHERE present_class = '$pupilclass'";
...
<body>
    <div class="wrapper">
        ...
        <div id="content" style="overflow: auto; height: 400px;">
            ...
            <div class="form-group row" >
                <div class="col-sm-4">
                    <label class="info">Select Present Class</label>
    ...
    <option value="Grade 5">Grade 5</option>
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label class="info" >Select New Class</label>
                </div>
                <div class="col-sm-6">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
          ...
          function modalInfo1(){
            ...
            var newClassVal = newClass.options[newClass.selectedIndex].text;
            var newClass1 = document.getElementById('newclass1');
            
                pclass1.innerHTML = pclassVal;
                newClass1.innerHTML = newClassVal;
          }
