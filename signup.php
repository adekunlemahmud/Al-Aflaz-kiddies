...
if(isset($_POST['submit'])){
   ...
   $unhashed_password = trim($_POST['password']);
...
if (mysqli_num_rows($checkUsername) > 0) {
   ...
   if( $username == '' || $unhashed_password == '' || $confirmpassword == '' || $hashed_password == ''){
     $isValid = false;
     $error_message = "Please fill all fields.";
   }

   // Check if confirm password matching or not
   if($isValid && ($unhashed_password != $confirmpassword) ){
     $isValid = false;
...
<div class="modal fade" id="myModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class=""><h3 class="info">WELCOME!!!</h3></div>
 	<p> Please kindly signup with new username and password</p>
      </div>
  ...
  <div class="card-body">
    ...
    <label class="info" >Enter UserName</label>
    <input name="username" type="text"  class="form-control form-text" id="userName" placeholder="Enter UserName">
                <!-- <span class="help-block info"><?php echo $username_err; ?></span> -->
  </div>
            <div >

    <label  class="info">Enter Password</label>
   ...
   <div>
    ...
    <label  class="info">Reenter Password</label>
    <input name="confirmpassword" type="password"  class="form-control form-text"  placeholder="Enter Password">
    <!-- <span class="help-block info"><?php echo $password_err; ?></span> -->
  </div>
   <input type="submit" name="submit" class="btn btn-card" value="Signup">
