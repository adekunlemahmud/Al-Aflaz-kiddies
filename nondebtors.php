...
if(isset($_SESSION['username'])){
    ...
    // $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance > 0 AND purpose_of_payment = 'First Term'");
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.16.0/js/mdb.min.js"></script>
    ...
    <style type="text/css">
        ...
        .btn-primary {
            background-color: #37ed67 !important;
        }
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Play Class'");
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Play Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Play Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Play Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Play Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Play Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Preparatory Class'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Nursery 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Nursery 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 1'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 2'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 3'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 4'");
                                    while ($output = mysqli_fetch_assoc($select)){
...
<!-- First Term collapse -->
  ...
  <div class="card card-body">
    <div class="table-responsive">
        <?php
                                     ...
                                     $select = mysqli_query($link, "SELECT COUNT(pupil_name) from payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 5'");
                                    while ($output = mysqli_fetch_assoc($select)){
                                        $count = $output['COUNT(pupil_name)'];
        echo"
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'First Term' AND class = 'Grade 5'");
                                    while ($output = mysqli_fetch_assoc($select)){
  ...
  <div class="card card-body">
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Second Term' AND class = 'Grade 5'");
                                    while ($output = mysqli_fetch_assoc($select)){
...
<!-- Third Term collapse -->
  ...
  <div class="card card-body">
    ...
    ?>
                            ...
                            <?php
                                     $select = mysqli_query($link, "SELECT * FROM payment WHERE Balance <= 0 AND purpose_of_payment = 'Third Term' AND class = 'Grade 5'");
                                    while ($output = mysqli_fetch_assoc($select)){
